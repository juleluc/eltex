...
void test_add(){
    ...
    double result_add;
    int status_add = operation_func[0](size_add, numbers_add, &result_add);
    if (status_add == 0) {
        printf("Result: %.2lf\n", result_add);
    } else {
        printf("Error\n");
...
void test_sub(){
    ...
    double result_sub;
    int status_sub = operation_func[1](size_sub, numbers_sub, &result_sub);
    if (status_sub == 0) {
        printf("Result: %.2lf\n", result_sub);
    } else {
        printf("Error\n");
...
void test_mult(){
    ...
    double result_mul;
    int status_mul = operation_func[2](size_mul, numbers_mul, &result_mul);
    if (status_mul == 0) {
        printf("Result: %.2lf\n", result_mul);
    } else {
        printf("Error\n");
...
void test_div(){
    ...
    double result_div;
    int status_div = operation_func[3](size_div, numbers_div, &result_div);
    if (status_div == 0) {
        printf("Result:%.2lf\n", result_div);
    } else {
        printf("Error\n");
    ...
    int status_div_zero = operation_func[3](size_div_zero, numbers_div_zero, &result_div_zero);
